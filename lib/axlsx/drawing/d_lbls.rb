...
module Axlsx
  ...
  class DLbls
    ...
    # @return [Symbol]
    def d_lbl_pos
      return unless [PieChart, Pie3DChart, Doughnut3DChart, LineChart].include? @chart_type
    ...
    def validate_attributes_for_chart_type
      return if [PieChart, Pie3DChart, Doughnut3DChart, LineChart].include? @chart_type
